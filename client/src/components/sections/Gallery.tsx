    ...
    <section className="py-24 bg-white border-t border-border">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-[600px]">
          ...
          <div className="row-span-3 bg-gray-100 rounded-xl overflow-hidden group relative">
            <img
              src={solderImg}
              alt="Soldering Work"
              className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
          ...
          <div className= "row-span-4 col-span-2 bg-gray-100 rounded-xl overflow-hidden group relative">
            <img
              src={MicrosoftImg}
              alt="Soldering Work"
              className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
            ...
            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
            <span className="text-white text-xs font-medium">
              Visit To Microsoft Headquarters
            </span>
              </div>
          </div>
        </div>

        <div className= "col-span-1 bg-gray-100 rounded-xl overflow-hidden group relative">
            <img
              src={curaImg}
              alt="Soldering Work"
              className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
